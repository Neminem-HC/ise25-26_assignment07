...
public class ReviewController extends CrudController<Review, ReviewDto, Long> {
    ...
    public @NonNull ResponseEntity<ReviewDto> getById(
            @Parameter(description = "Unique identifier of the Review to retrieve.", required = true) @PathVariable Long id) {
    ...
    public @NonNull ResponseEntity<ReviewDto> create(
            @Parameter(description = "Data of the Review to create.", required = true) @RequestBody @Valid ReviewDto reviewDto) {
    ...
    public @NonNull ResponseEntity<ReviewDto> update(
            @Parameter(description = "Unique identifier of the Review to update.", required = true) @PathVariable Long id,
            @Parameter(description = "Data of the Review to update.", required = true) @RequestBody @Valid ReviewDto reviewDto) {
    ...
    public @NonNull ResponseEntity<Void> delete(
            @Parameter(description = "Unique identifier of the Review to delete.", required = true) @PathVariable Long id) {
    ...
    public ResponseEntity<List<ReviewDto>> filter(
            @Parameter(description = "Name of the Review to retrieve.", required = true) @RequestParam("pos_id") Long posId,
